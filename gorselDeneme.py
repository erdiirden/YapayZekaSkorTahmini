...
def button_click():
    ...
    # Simulasyon Skor
    simulasyon1 = ((tahmin_skor1istatistik*1.1) + (tahmin_skor1maclar*5*1.2) ) / 5.5
    simulasyon2 = ((tahmin_skor2istatistik*0.6) + (tahmin_skor2maclar*5*0.9) ) / 6.5
    ...
    # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    # skorYaz.config(text=simuskor1+" - "+simuskor2)
    skorYaz.config(text=str(int(simuskor1)) + " - " + str(int(simuskor2)))
    print(sum(simulasyon1)/len(simulasyon1))
    print(round(simulasyon1))
